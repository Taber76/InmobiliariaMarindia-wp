            ...
            <p id="progress_details" class="realtyna_success_bg realtyna_success_text" style="text-align:center; margin:10px;padding:10px; font-weight:bold;">
                <?php
                    ...
                    if ( !empty( $totalImported ) ){
                        ...
                        echo '<span class="dashicons dashicons-info"></span> ' . $totalImported . ' ' . __( 'Listings imported.' , REALTYNA_MLS_SYNC_SLUG );
                    ...
                    if ( !empty( $latestSync ) ){
                        ...
                        echo '<span class="dashicons dashicons-update"></span> ' . __( 'Latest Sync at ' , REALTYNA_MLS_SYNC_SLUG ) . date( "Y/m/d H:i:s" , $latestSync );
