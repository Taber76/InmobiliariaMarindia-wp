...
class Property {
    ...
    private function fieldsDependencyChecker(){
        ...
        if ( empty( $this->getValue( 'houzez_geolocation_lat' ) ) && empty( $this->getValue( 'houzez_geolocation_long' ) ) && empty( $this->getValue( self::THEME_FIELD_PREFIX . 'property_map_address' ) ) ){
